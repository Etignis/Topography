...
if(localStorage.getItem("flag_blur")!= null)
  ...
  function make_town() {
    ...
    var name_line_1_she = "Ясная, Светлая, Дальняя, Старая, Большая, Малая, Новая, Ближняя, Темная, Стылая, Быкова, Кривая, Крутая, Лысая, Верхняя, Веселая, Степная, Лесная, Сухая, Лебяжья, Песчаная, Сонная, Горбатая";
    ...
    var name_line_2_she = "Холмовка, Бобровка, Падь, Куща, Балка, Горка, Скала, Грязь, Куриловка, Башня, Дубовка, Муходёровка, Бородёнка, Волчатка, Рыбушка, Вышенка, Дубрава, Капустинка, Калуженка, Гать, Речка, Долинка, Хорошавка, Калиновка, Нечаевка, Рожковка, Утянка, Глушинка, Пустынь, Кедровка, Шумиха, Травка, Отмель, Бурлинка, Лощина, Гора, Дубрава";
